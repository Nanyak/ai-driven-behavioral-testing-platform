#!/usr/bin/env node
// Routing: `attributes.has_errors === true` -> `edge/`, else by persona ->
// guest_shopper -> guest/, registered_customer -> customer/, admin_operator ->
// admin/. There is no `edge` persona.
 ...
 * \`--project <persona>\` and get per-persona pass/fail counts. This config is
