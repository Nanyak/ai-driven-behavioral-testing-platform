...
- The project will use `npm` for Node.js and TypeScript packages.
...
4. Add root package metadata with `package.json` and keep Medusa dependencies locked with `package-lock.json`.
